...
export class Backend implements backendInterface {
    ...
    async deleteVideo(arg0: Uint8Array): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getVideo(arg0: Uint8Array): Promise<Video | null> {
        if (this.processError) {
            try {
    ...
    async uploadVideo(arg0: string, arg1: string, arg2: ExternalBlob): Promise<Uint8Array> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadVideo(arg0, arg1, await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
